...
import org.record.avtice.DBHelper;
...
public class DBHelperTest {
	...
	// save
	// 后面的类同，只是单纯的替换而已，暂就不改后面的了
	@Test
	public void save() {
		BlgArticle ba = new BlgArticle(45, 12, "en", "en");
		DBHelper<BlgArticle> dbh = new DBHelper<BlgArticle>(ba.getClass());
		dbh.save(ba);
	}
	@Test
	public void save1() {
